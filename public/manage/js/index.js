...
}).define(['layer', 'laypage'], function(exports){
    exports('loginout', function(){
        $.post("/manage/index/loginout",function(data){
            if(data.error_code==0){
                layer.msg(data.msg, {time: 1500, icon:6,shade: 0.4},function(){
                    window.location.href="/manage/login/showlogin";
                });
            }else{
                layer.msg(data.msg, {time: 1500, icon:5,shade: 0.4});
			}
		})
    });
});
