<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:39:"./Template/manage\admin\adminGroup.html";i:1531410750;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
...
<script type="text/html" id="barDemo">
	...
	<a class="layui-btn layui-btn-xs" lay-event="editnews">编辑</a>

	<a class="layui-btn layui-btn-xs" lay-event="power">权限编辑</a>
	
	<a class="layui-btn layui-btn-danger layui-btn-xs" lay-event="del">删除</a>
</script>

<script type="text/javascript" src="/public/layui/layui.js"></script>
<script type="text/javascript" src="/public/manage/js/admingroupList.js"></script>
