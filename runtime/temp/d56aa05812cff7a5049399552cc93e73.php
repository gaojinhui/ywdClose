<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:38:"./Template/manage\video\videolist.html";i:1533196781;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
...
<script type="text/html" id="barDemo">
	<a class="layui-btn layui-btn-xs" lay-event="shownews">详情</a>
	<a class="layui-btn layui-btn-danger layui-btn-xs" lay-event="del">编辑</a>
	<!--<a class="layui-btn layui-btn-danger layui-btn-xs" lay-event="review">评论</a>-->
	<a class="layui-btn layui-btn-danger layui-btn-xs" lay-event="delvideo">删除</a>
</script>

<script type="text/javascript" src="/public/layui/layui.js"></script>
<script type="text/javascript" src="/public/layui/layui.all.js"></script>
<script type="text/javascript" src="/public/manage/js/video/videoList.js"></script>
