<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:36:"./Template/manage\banner\banner.html";i:1531410750;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
...
<div class="layui-btn-group demoTable" >
	...
	<button class="layui-btn" data-type="isAll">验证是否全选</button>
		...
		<script type="text/html" id="switchTpl">
			<input type="checkbox" name="sex" value="{{d.status}}" bid="{{d.id}}" lay-skin="switch" lay-text="显示|隐藏" lay-filter="sexDemo" {{ d.status == 1 ? 'checked' : '' }}>
		</script>
	...
	<script type="text/javascript" src="/public/manage/js/banner.js"></script>
