<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:36:"./Template/manage\news\newsList.html";i:1531410750;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
...
<script type="text/html" id="barDemo">
	...
	<a class="layui-btn layui-btn-xs" lay-event="shownews">预览</a>
	
	<a class="layui-btn layui-btn-danger layui-btn-xs" lay-event="del">删除</a>
</script>

<script type="text/javascript" src="/public/layui/layui.js"></script>
<script type="text/javascript" src="/public/manage/js/newsList.js"></script>
