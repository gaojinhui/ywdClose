<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:39:"./Template/manage\menu\menu_update.html";i:1531410750;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
	...
	<link rel="stylesheet" href="/public/manage/menu.css" media="all" />
...
<body class="childrenBody">
	<form class="layui-form" action="javascript:">
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<input type="text" name="href" class="layui-input" lay-verify="titl" placeholder="输入菜单链接"  value="<?php echo (isset($list['url']) && ($list['url'] !== '')?$list['url']:''); ?>">
			</div>
		</div>
		<div class="layui-form-item">
		...
		<div class="layui-form-item">
			...
			<div class="site-demo-upload">
				...
				<?php if($list['litpic']!==''){	?>
					<img id="litpic" style="width: 300px; height: 135px;  margin-top: -60px;" src="<?php echo (isset($list['litpic']) && ($list['litpic'] !== '')?$list['litpic']:''); ?>"/>
				<?php }else{ ?>
					<img id="litpic" style="width: 300px; height: 135px;  display:none; margin-top: -60px;" src="<?php echo (isset($list['litpic']) && ($list['litpic'] !== '')?$list['litpic']:''); ?>"/>
				<?php } ?>
			</div>
		</div>
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<script id="editor" type="text/plain" class="layui-form-item"><?php echo (isset($list['body']) && ($list['body'] !== '')?$list['body']:''); ?></script>
			</div>
		</div>
		<div class="layui-form-item">
			<div class="layui-input-block">
	...
	<script type="text/javascript" src="/public/manage/js/menu_update.js"></script>
