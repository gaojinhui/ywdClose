<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:32:"./Template/manage\menu\icon.html";i:1531410750;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
	...
	<link rel="stylesheet" href="/public/manage/css/menu.css" media="all" />
</head>
    ...
    layui.use(['form','layer','jquery','layedit','laydate'],function(){
        var form = layui.form,
			...
			$('li').on('click', function(){
				...
				var ico =$(this).find(".code").text();
				window.localStorage.setItem("ico",ico);
